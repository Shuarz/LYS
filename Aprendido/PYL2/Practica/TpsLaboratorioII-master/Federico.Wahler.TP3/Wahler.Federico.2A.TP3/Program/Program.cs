...
namespace Program
{
    class Program
    {
        /*### Profe disculpe que las carpetas se llamen clases abstractas y instanciables, al final vi que el "program" llevaba el nombre de entidades,
         cambie los nombre y todo corre bien ###*/
