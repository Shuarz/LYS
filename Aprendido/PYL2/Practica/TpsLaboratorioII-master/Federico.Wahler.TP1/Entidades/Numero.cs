...
namespace Entidades
{
    public class Numero
    {
        ...
        /// <summary>
        /// Propiedad que le asigna un valor al campo ElNumero de la clase Numero.
        /// </summary>
        private string SetNumero
        {
            set
            {
                ElNumero = ValidarNumero(value);
            }
        }
        #endregion
        ...
        {
            return n1.ElNumero + n2.ElNumero;
        }
