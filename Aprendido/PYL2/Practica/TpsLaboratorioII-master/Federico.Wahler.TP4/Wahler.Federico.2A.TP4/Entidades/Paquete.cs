...
namespace Entidades
{
    ...
    {  
        ...
        /// <summary>
        /// Propiedad de lectura/escritura del atributo numeroPedido
        /// </summary>
        ...
        public Paquete(string numeroPedido, string trackingID)
        {
        ...
        public string MostrarDatos(IMostrar<Paquete> elemento)
        {
            ...
            return string.Format("{0} para {1}", paq.TrackingID, paq.NumeroPedido);
        }
