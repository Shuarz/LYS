...
int ePelicula_menuConsultar(ePelicula listadoPelicula[], int limite, eDirector listadoDirector[], int limiteDirector)
{
    ...
    {
        printf("Consultar:\n");
        printListStringsChars(7,"la/s pelicula mas vieja:", "Lista de Peliculas con director:"
                              , "Los Directores con sus peliculas", "Peliculas Dirigidas por un director"
                              , "Todas las peliculas cuyo director sea argentino", "Cantidad de peliculas por nacionalidad", "cancelar");
